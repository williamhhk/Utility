namespace ROOT.CIMV2.Win32
{
    ...
    public class ComputerSystem : System.ComponentModel.Component
    {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Status and Additional Data fields that identify the boot status")]
        public ushort[] BootStatus
        {
            get
            {
                return ((ushort[])(curObj["BootStatus"]));
            }
        }
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Number of null-terminated string describing the chassis or enclosure SKU number")]
        public string ChassisSKUNumber
        {
            get
            {
                return ((string)(curObj["ChassisSKUNumber"]));
            }
        }
 ...
 Note that the CIM_ComputerSystem Name calculated using the heuristic is the system's key value. Other names can be assigned and used for the CIM_ComputerSystem that better suit the business, using Aliases.")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("This text string identifies the family to which a particular computer belongs. A " +
            "family refers to a set of computers that are similar but not identical from a ha" +
            "rdware or software point of view")]
        public string SystemFamily
        {
            get
            {
                return ((string)(curObj["SystemFamily"]));
            }
        }

        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("This text string identifies a particular computer configuration for sale. It is s" +
            "ometimes also called a product ID or purchase order number")]
        public string SystemSKUNumber
        {
            get
            {
                return ((string)(curObj["SystemSKUNumber"]));
            }
        }
